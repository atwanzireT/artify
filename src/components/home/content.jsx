...
import { HeartIcon, ChatBubbleBottomCenterIcon, PlusCircleIcon } from "@heroicons/react/24/solid"
import img from "../images/abstract.jpg"
import img2 from "../images/african-woman.jpg"
import img3 from "../images/african_art.jpg"
import img4 from "../images/african_girl.jpg"
import img5 from "../images/brushes.jpg"
import img6 from "../images/camera.jpg"
import img7 from "../images/fashion.jpg"
import img8 from "../images/meals.jpg"
import img9 from "../images/photograph.jpg"
import img10 from "../images/pottery.jpg"
import img11 from "../images/meals.jpg"
            ...
            <div>
                <div className="text-center mx-5">
                    <div className="grid grid-cols-4 gap-2">
                        ...
                        <div className="h-7/12 mt-14 flex items-center">
                            <div>
                                <img className="rounded-2xl artify-img" src={img2} alt="" />
                                <div className="img-btns">
                                    <div className="grid grid-cols-4 m-auto items-center h-6">
                                        <div><img src={img3} className="icon w-12 h-12 m-auto rounded-full border bottom-2 border-white hover:bg-white hover:p-1 hover:rounded-xl hover:w-14 hover:h-14" alt="" /></div>
                                        <div><HeartIcon className="icon w-10 h-10 m-auto bg-gray-500 rounded-xl opacity-70 hover:opacity-100 p-1 text-white hover:text-red-900 hover:bg-white hover:p-1 hover:rounded-xl hover:h-10 hover:w-10" /></div>
                        ...
                        <div className="h-7/12 mt-14 flex items-center">
                            <div>
                                <img className="rounded-2xl artify-img" src={img3} alt="" />
                                <div className="img-btns">
                                    <div className="grid grid-cols-4 m-auto items-center h-6">
                                        <div><img src={img3} className="icon w-12 h-12 m-auto rounded-full border bottom-2 border-white hover:bg-white hover:p-1 hover:rounded-xl hover:w-14 hover:h-14" alt="" /></div>
                                        <div><HeartIcon className="icon w-10 h-10 m-auto bg-gray-500 rounded-xl opacity-70 hover:opacity-100 p-1 text-white hover:text-red-900 hover:bg-white hover:p-1 hover:rounded-xl hover:h-10 hover:w-10" /></div>
                        ...
                        <div className="h-7/12 mt-14 flex items-center">
                            <div>
                                <img className="rounded-2xl artify-img" src={img4} alt="" />
                                <div className="img-btns">
                                    <div className="grid grid-cols-4 m-auto items-center h-6">
                                        <div><img src={img3} className="icon w-12 h-12 m-auto rounded-full border bottom-2 border-white hover:bg-white hover:p-1 hover:rounded-xl hover:w-14 hover:h-14" alt="" /></div>
                                        <div><HeartIcon className="icon w-10 h-10 m-auto bg-gray-500 rounded-xl opacity-70 hover:opacity-100 p-1 text-white hover:text-red-900 hover:bg-white hover:p-1 hover:rounded-xl hover:h-10 hover:w-10" /></div>
                        ...
                        <div className="h-7/12 mt-14 flex items-center">
                            <div>
                                <img className="rounded-2xl artify-img" src={img5} alt="" />
                                <div className="img-btns">
                                    <div className="grid grid-cols-4 m-auto items-center h-6">
                                        <div><img src={img3} className="icon w-12 h-12 m-auto rounded-full border bottom-2 border-white hover:bg-white hover:p-1 hover:rounded-xl hover:w-14 hover:h-14" alt="" /></div>
                                        <div><HeartIcon className="icon w-10 h-10 m-auto bg-gray-500 rounded-xl opacity-70 hover:opacity-100 p-1 text-white hover:text-red-900 hover:bg-white hover:p-1 hover:rounded-xl hover:h-10 hover:w-10" /></div>
